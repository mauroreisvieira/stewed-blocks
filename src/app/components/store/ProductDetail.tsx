    ...
    return (
        <Box justify="between" gap="2xl" wrap="wrap">
            ...
            <Box direction="column" gap="2xl" grow>
                ...
                <FormField>
                    <FormField.Label htmlFor="quantity">
                        Quantidade
                    </FormField.Label>
                    <FormField.Control>
                        <TextField
                ...
                <Box gap="lg" direction="column">
                    <Text size="sm" skin="neutral">
                        Inclui uma etiqueta interativa na gola que concede
                        acesso ao Club LEGACIES.
                    </Text>
                    <Accordion>
                        <Accordion.Item>
                            <Accordion.Header rightSlot={<FiPlus />}>
                                Detalhes do Produto
                            </Accordion.Header>
                            <Accordion.Body>
                                <Box direction="column" gap="lg">
                                    <Text>
                                        Esta coleção inspira-se na mítica águia,
                                        com uma nova abordagem poderosa que
                                        combina tradição e celebra a
                                        individualidade do Benfica.
                                    </Text>
                                    <List>
                                        <List.Item>
                                            Algodão LEGACIES de peso médio
                                        </List.Item>
                        ...
                        <Accordion.Item>
                            ...
                            <Accordion.Body>
                                <Text>
                                    As nossas sweatshirts com capuz têm um
                                    tamanho grande. Se desejar um tamanho
                                    normal, diminua o tamanho do seu tamanho
                                    habitual.
                                </Text>
                            </Accordion.Body>
                        </Accordion.Item>
